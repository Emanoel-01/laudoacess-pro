        ...
        <Sidebar className="border-r border-slate-200 bg-white">
          <SidebarHeader className="border-b border-slate-200 p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="font-bold text-slate-900 text-lg">LaudoAcess</h2>
                <p className="text-xs text-slate-500">Laudos de Acessibilidade</p>
              </div>
            </div>
          </SidebarHeader>
          ...
          <header className="bg-white/80 backdrop-blur-sm border-b border-slate-200 px-6 py-4 md:hidden sticky top-0 z-10">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <h1 className="text-lg font-bold text-slate-900">LaudoAcess</h1>
              </div>
            </div>
          </header>
